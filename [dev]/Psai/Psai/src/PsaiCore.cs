...
namespace psai.net
{
	...
	public class ThemeInfo
	{
        ...
        /// <summary>
        /// Returns a string representation of the ThemeInfo object.
        /// </summary>
    ...
    public class PsaiCore
    {
        ...
        /// <summary>
        /// Returns true if the PsaiCore singleton instance initialization is complete.
        /// </summary>
        ...
        /// <summary>
        /// Loads the xml soundtrack configuration file as exported by the psai Editor.
        /// </summary>
        /// <param name="pathToProjectFile">a file path to the xml  psai soundtrack file created by the psaiEditor during export.</param>
        /// <returns>PsaiResult.OK if successful</returns>
        ...
        /// Sets the fadeout time in seconds. The parameters is only applicatble if 'immediately' is set to false.
        /// </param>
        /// <returns>
        ///  <list type="table">
        ///    <item>
        ...
        {
            return m_logik.StopMusic(immediately, (int)(fadeOutSeconds * 1000));
        }
        ...
        /// <param name="immediately">True: Go to rest immediately by fading out. False: play an End-Segment</param>
        /// <param name="fadeOutSeconds">the fade-out time in seconds</param>
        /// <param name="restTimeMin">the lower limit of the random resting time in seconds</param>
        /// <param name="restTimeMax">the upper limit of the random resting time in seconds</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Explicitly sets the last Basic Mood that psai will eventually play when waking up from Rest Mode.
        /// </summary>
        /// <remarks>
        /// The last Basic Mood is internally always set whenever a Basic Mood is triggered (by calling TriggerMusicTheme).
        /// However in some situations you might find it useful to set it explicitly by using this method. E.g.
        /// setting this to 0 or -1 will prevent psai from automatically playing the last Basic Mood after an Action Theme had been playing.
        /// Psai will then keep silent until the next call to TriggerMusicTheme().
        /// </remarks>
        /// <param name="themeId">the Basic Mood's themeId</param>
        ...
        /// <summary>
        /// Internal method for registering a LoggerOutput for writing log information to files or console windows.
        /// </summary>
        /// <param name="loggerOutput">loggerOutput</param>

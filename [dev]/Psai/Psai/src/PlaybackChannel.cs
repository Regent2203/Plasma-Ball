...
namespace psai.net
{
    ...
    public class PlaybackChannel
    {
        ...
        /// <summary>
        /// true for regular, timing-critical channels. false for highlights.
        /// </summary>
        ...
        /// Ctor
        /// </summary>
        /// <param name="logik"></param>
        /// <param name="isMainChannel">true for regular, timing-critical channels. false for highlights.</param>
        internal PlaybackChannel(Logik logik, bool isMainChannel)
        {
            #if PSAI_STANDALONE
                m_audioPlaybackLayerChannel = new AudioPlaybackLayerChannelOpenTK();            
            #else
                m_audioPlaybackLayerChannel = new AudioPlaybackLayerChannelUnity(this);                
            #endif
        ...
        /// <summary>
        /// This may be called by the AudioPlaybackLayerChannel to update the timers / timestamps
        /// </summary>
